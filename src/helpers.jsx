...
export const gameStatus = {
  starting: [0, "Inicie o jogo", "info"]
  , active: [1, "Jogo em progresso", "primary"]
  , whiteWon: [2, "Brancas venceram", "danger"]
  , blackWon: [3, "Pretas venceram", "danger"]
  , draw: [4, "Empate", "warning"]
}
